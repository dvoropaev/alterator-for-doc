...
Предоставляет команды управления репозиториями на базе apt-repo.

| Метод | Описание |
|--------|---------|
| [Info](#method-Info) | Возвращает статический дескриптор объекта бэкенда repo. |
...
Возвращает статический дескриптор объекта бэкенда repo.
...
Поддерживает пути к файлам или строки URI, принимаемые apt-repo.
#### Выходные аргументы
...
Идентификатор или путь репозитория для удаления.
