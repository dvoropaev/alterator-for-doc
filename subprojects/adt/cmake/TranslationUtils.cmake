function(add_translation_resource out_file prefix)
  set(qm_files ${ARGN})
  set(resource ${CMAKE_CURRENT_BINARY_DIR}/${prefix}.tr.qrc)
...
function(add_translation out_files)
  ...
  foreach(filename ${ARGN})
    ...
    set(qm "${CMAKE_CURRENT_BINARY_DIR}/${basename}.qm")
    add_custom_command(
      OUTPUT "${qm}"
      COMMAND "lrelease-qt6"
      ARGS -markuntranslated "Is not translated!" -nounfinished
        -removeidentical -compress "${filename}" -qm "${qm}"
