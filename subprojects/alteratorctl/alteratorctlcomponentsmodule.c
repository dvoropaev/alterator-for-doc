...
#define BATCH_COMPONENT_CATEGORIES_INTERFACE_NAME \
    "org.altlinux.alterator.batch_component_categories1"
...
#define COMPONENTS_OTHER_SECTION_NAME "__other"
...
static components_module_subcommands_t components_module_subcommands_list[] =
...
static gboolean show_other                          = FALSE;
...
static int components_module_parse_options(AlteratorCtlComponentsModule* module, int* argc,
                                           char** argv);
static int components_module_parse_arguments(AlteratorCtlComponentsModule* module, int argc,
                                             char** argv, alteratorctl_ctx_t** ctx);

static int components_module_list_subcommand(AlteratorCtlComponentsModule* module,
                                             alteratorctl_ctx_t** ctx);
static int components_module_info_subcommand(AlteratorCtlComponentsModule* module,
                                             alteratorctl_ctx_t** ctx);
static int components_module_install_subcommand(AlteratorCtlComponentsModule* module,
                                                alteratorctl_ctx_t** ctx);
static int components_module_remove_subcommand(AlteratorCtlComponentsModule* module,
                                               alteratorctl_ctx_t** ctx);
static int components_module_description_subcommand(AlteratorCtlComponentsModule* module,
                                                    alteratorctl_ctx_t** ctx);
static int components_module_status_subcommand(AlteratorCtlComponentsModule* module,
                                               alteratorctl_ctx_t** ctx);
static int components_module_search_subcommand(AlteratorCtlComponentsModule* module,
                                               alteratorctl_ctx_t** ctx);

static int components_module_handle_results(AlteratorCtlComponentsModule* module,
                                            alteratorctl_ctx_t* ctx);
static int components_module_handle_info_results(AlteratorCtlComponentsModule* module,
                                                 alteratorctl_ctx_t** ctx);
static int components_module_handle_list_results(AlteratorCtlComponentsModule* module,
                                                 alteratorctl_ctx_t** ctx);
static int components_module_handle_install_results(AlteratorCtlComponentsModule* module,
                                                    alteratorctl_ctx_t** ctx);
static int components_module_handle_remove_results(AlteratorCtlComponentsModule* module,
                                                   alteratorctl_ctx_t** ctx);
static int components_module_handle_description_results(AlteratorCtlComponentsModule* module,
                                                        alteratorctl_ctx_t** ctx);
static int components_module_handle_status_results(AlteratorCtlComponentsModule* module,
                                                   alteratorctl_ctx_t** ctx);

static int components_module_print_list_with_filters(AlteratorCtlComponentsModule* module,
                                                     GNode* root, const gchar* section_display_name,
                                                     const gchar* section_name,
                                                     gboolean is_first_section,
                                                     gboolean is_last_section);

static GNode** components_module_get_section_nodes(AlteratorCtlComponentsModule* module,
                                                   gsize* amount_of_sections);
...
static gchar** components_module_get_desktop_environments(AlteratorCtlComponentsModule* module,
                                                          gsize* len);

static int components_module_is_ignore_package_by_arch(AlteratorCtlComponentsModule* module,
                                                       GNode* package_data, gboolean* result,
...
static int components_module_is_ignore_package_by_language(AlteratorCtlComponentsModule* module,
                                                           ...
                                                           gsize len);
static int components_module_is_ignore_package_by_desktop_env(
    AlteratorCtlComponentsModule* module, GNode* package_data, gboolean* result,
    gchar** optional_current_desktop_envs, gboolean use_optional_current_desktop_envs, gsize len);
static int components_module_get_package_name(AlteratorCtlComponentsModule* module,
                                              GNode* package_data, gchar** result);

static void components_module_print_legend();

static int components_module_print_pseudo_graphic_tree(AlteratorCtlComponentsModule* module,
                                                       GNode* node);
static int
components_module_print_pseudo_graphic_tree_to_buffer(AlteratorCtlComponentsModule* module,
                                                      GNode* node, GString* master_buffer);
static int components_module_print_pseudo_graphic_subtree(AlteratorCtlComponentsModule* module,
                                                          GNode* node, gchar* prefix,
                                                          gboolean is_last, gboolean is_first);

static int components_module_print_tree(AlteratorCtlComponentsModule* module, GNode* node);
static int components_module_print_tree_to_buffer(AlteratorCtlComponentsModule* module, GNode* node,
                                                  GString* master_buffer);
static int components_module_print_subtree(AlteratorCtlComponentsModule* module, GNode* node,
                                           gchar* prefix);

static int components_module_print_list(AlteratorCtlComponentsModule* module, GNode* node);
static int components_module_print_list_to_buffer(AlteratorCtlComponentsModule* module, GNode* node,
                                                  GString* master_buffer);
static int components_module_print_sublist(AlteratorCtlComponentsModule* module, GNode* node,
                                           gchar* prefix);
...
static int components_module_sort_tree_elems_by_name(AlteratorCtlComponentsModule* module,
                                                     GNode** root);
...
static gint components_module_sort_tree_compare_func(gconstpointer a, gconstpointer b,
                                                     gpointer user_data);

static int components_module_validate_alterator_entry(AlteratorGDBusSource* source,
                                                      GNode* alterator_entry_data);

static int components_module_get_components(AlteratorCtlComponentsModule* module,
                                            GHashTable** result);
static int components_module_install_component(AlteratorCtlComponentsModule* module,
                                               alteratorctl_ctx_t** ctx);
static int components_module_remove_component(AlteratorCtlComponentsModule* module,
                                              alteratorctl_ctx_t** ctx);

static int components_module_get_components_info(AlteratorCtlComponentsModule* module,
                                                 GHashTable** result);

static int
components_module_get_components_uninstalled_packages(AlteratorCtlComponentsModule* module,
                                                      GHashTable** result);

static int components_module_get_component_status_by_uninstalled_packages_list(
    AlteratorCtlComponentsModule* module, const GNode* parsed_component,
    const GHashTable* uninstalled_packages, gchar* current_arch, gchar** current_locales,
    gsize locales_len, gchar** current_desktop_environments, gsize env_len,
...
static int components_module_get_component_packages(AlteratorCtlComponentsModule* module,
                                                    ...
                                                    GHashTable** packages);
static int components_module_get_installed_packages(AlteratorCtlComponentsModule* module,
                                                    GHashTable** packages);
...
static int components_module_calculate_affected_components(
    AlteratorCtlComponentsModule* module, const gchar* target_component_str_id, gchar** packages,
    components_module_transaction_mode action, GHashTable** result);
...
static int components_module_get_base_section_packages(AlteratorCtlComponentsModule* module,
                                                       GHashTable** result);

static int components_module_get_component_status(AlteratorCtlComponentsModule* module,
                                                  char* component_str_id, int* status,
...
static int components_module_get_category_info(AlteratorCtlComponentsModule* module,
                                               const gchar* category_str_id, gchar** result);

static int components_module_get_categories_info(AlteratorCtlComponentsModule* module,
                                                 GHashTable** result);

static int components_module_categories_list(AlteratorCtlComponentsModule* module,
                                             GHashTable** result);

static void components_module_tree_elem_init(components_module_tree_elem_t* elem,
                                             components_module_tree_elem_type type, gchar* name,
                                             gchar* display_name, gchar* category);

static void components_module_tree_elem_free(gpointer node_elem);

static void components_module_create_categories_links(gpointer key, gpointer value,
                                                      gpointer user_data);

static void components_module_create_sections_categories_links(gpointer key, gpointer value,
                                                               gpointer user_data);

static void components_module_delete_sections_categories_links(gpointer key, gpointer value,
                                                               gpointer user_data);
...
static int components_module_get_display_name(AlteratorCtlComponentsModule* module,
                                              ...
                                              components_module_tree_elem_type type, GNode* data,
                                              gchar** result);

static int components_module_get_section_display_name(AlteratorCtlComponentsModule* module,
                                                      GNode* data, gchar** result);
    ...
    if (!components_module_type)
    {
        ...
        const GInterfaceInfo alterator_module_interface_info = {
            ...
            (GInterfaceFinalizeFunc)
                components_module_alterator_interface_finalize, /* interface_finalize */
            NULL                                                /* interface_data */
        };

        components_module_type = g_type_register_static(G_TYPE_OBJECT, /* parent class */
                                                        "AlteratorCtlComponentsModule",
                                                        &components_module_info, 0);

        g_type_add_interface_static(components_module_type, TYPE_ALTERATOR_CTL_MODULE,
...
alterator_ctl_module_t* get_components_module(void)
{
    ...
    {
        gsize module_id_size = g_strlcpy(components_module.id, ALTERATOR_CTL_COMPONENTS_MODULE_NAME,
                                         strlen(ALTERATOR_CTL_COMPONENTS_MODULE_NAME) + 1);

        if (module_id_size != strlen(ALTERATOR_CTL_COMPONENTS_MODULE_NAME))
        {
            g_printerr(_(
                "Internal error in get_components_module: unvaliable id of components module.\n"));
            return NULL;
        }
...
{
    for (int i = 0;
         i < sizeof(components_module_subcommands_list) / sizeof(components_module_subcommands_t);
         i++)
        g_hash_table_insert(command, components_module_subcommands_list[i].subcommand,
...
GHashTable* calc_components_outside_sections(const GHashTable* components, const GNode** sections,
                                             gsize amonth_of_sections)
{
    GHashTable* result = g_hash_table_copy_table((GHashTable*) components, g_strdup_copy_func, NULL,
                                                 NULL, NULL);
...
static int print_components_section(AlteratorCtlComponentsModule* module, const GNode* section,
                                    gboolean print_other_section,
                                    GHashTable* components_nodes_table,
                                    GHashTable* categories_nodes_table, gboolean is_first_section,
                                    gboolean is_last_section)
{
    int ret             = 0;
    ...
    if (section)
    {
        ...
        if (chosen_sections
            && !g_strv_contains((const gchar* const*) chosen_sections, section_name))
            return ret;
    }

    // Clear links before parsing next section
    g_hash_table_foreach(components_nodes_table, components_module_delete_sections_categories_links,
                         NULL);
    g_hash_table_foreach(categories_nodes_table, components_module_delete_sections_categories_links,
                         NULL);

    // Restore default categories links
    g_hash_table_foreach(categories_nodes_table, components_module_create_categories_links,
    ...
    g_hash_table_foreach(categories_nodes_table,
                         components_module_reset_all_trees_category_installed_status, NULL);

    if (!print_other_section)
    {
        toml_value* components_array =
            g_hash_table_lookup(((alterator_entry_node*) section->data)->toml_pairs,
                                COMPONENTS_EDITION_SECTION_COMPONENTS_ARRAY_KEY_NAME);

        {
            ...
            gpointer components_links_params[2] = {(gpointer) categories_nodes_table,
                                                   (gpointer) section_components};
            g_hash_table_foreach(components_nodes_table,
                                 components_module_create_sections_categories_links,
                                 components_links_params);

            gpointer categories_links_params[2] = {(gpointer) categories_nodes_table,
                                                   (gpointer) section_components};
            g_hash_table_foreach(categories_nodes_table,
                                 components_module_create_sections_categories_links,
    ...
    {
        gpointer components_links_params[2] = {(gpointer) categories_nodes_table,
                                               (gpointer) components_nodes_table};
        g_hash_table_foreach(components_nodes_table,
                             components_module_create_sections_categories_links,
                             components_links_params);
    ...
    {
        components_module_tree_elem_t* category_data = (components_module_tree_elem_t*)
                                                           category->data;
    ...
    if (!print_other_section
        && components_module_get_section_display_name(module, (GNode*) section,
                                                      &locale_display_name)
               < 0)
    {
    ...
    components_module_print_list_with_filters(module, section_result,
                                              !print_other_section ? locale_display_name
                                                                   : _("Other components"),
                                              !print_other_section ? section_name
                                                                   : COMPONENTS_OTHER_SECTION_NAME,
                                              is_first_section, is_last_section);
                                             ...
                                             alteratorctl_ctx_t** ctx)
{
    ...
    GHashTable*
        categories_nodes_table = g_hash_table_new_full(g_str_hash, g_str_equal,
                                                       (GDestroyNotify) g_free,
                                                       (GDestroyNotify)
                                                           components_module_tree_elem_free);
    GHashTable*
        components_nodes_table                = g_hash_table_new_full(g_str_hash, g_str_equal,
                                                                      (GDestroyNotify) g_free,
                                                                      (GDestroyNotify)
                                                                          components_module_tree_elem_free);
    ...
    GNode** sections                          = NULL;
    GHashTable* all_section_names             = NULL;
    ...
    {
        g_printerr(
            _("The call to the components list method failed. The context doesn't exist.\n"));
        ERR_EXIT();
    }
    ...
    {
        all_section_names = g_hash_table_new_full(g_str_hash, g_str_equal, g_free, NULL);
        for (gsize i = 0; i < amount_of_sections; i++)
            g_hash_table_add(all_section_names,
                             g_strdup(((alterator_entry_node*) sections[i]->data)->node_name));
    }
    ...
    while (g_hash_table_iter_next(&categories_info_list_iter, &category_info, &categories_value))
    {
        ...
        if (info_parser->alterator_ctl_module_info_parser_get_data_from_text(info_parser,
            ...
            < 0)
        {
            g_printerr(_("Printing list of components with categories failed. Can't parse "
                         "categories data.\n"));
        ...
        toml_value* category_name_toml_value = g_hash_table_lookup(
            node_data->toml_pairs, COMPONENT_CATEGORY_ALTERATOR_ENTRY_COMPONENT_NAME_KEY_NAME);

        gchar* category_name = category_name_toml_value ? category_name_toml_value->str_value
                                                        : NULL;
        gchar* display_name  = NULL;
        if (!name_only && !path_only && !no_display_name
            && components_module_get_display_name(module, category_name, CATEGORY,
                                                  category_parsed_data, &display_name)
                   < 0)
        {
            alterator_ctl_module_info_parser_result_tree_free(category_parsed_data);
            ERR_EXIT();
        ...
        toml_value* parent_category_toml_value = g_hash_table_lookup(
            node_data->toml_pairs, COMPONENT_CATEGORY_ALTERATOR_ENTRY_COMPONENT_CATEGORY_KEY_NAME);

        gchar* parent_category = parent_category_toml_value ? parent_category_toml_value->str_value
                                                            : NULL;

        components_module_tree_elem_t* elem = g_malloc0(sizeof(components_module_tree_elem_t));
        components_module_tree_elem_init(elem, CATEGORY, category_name, display_name,
                                         parent_category);
    ...
    while (g_hash_table_iter_next(&components_info_list_iter, (gpointer) &component_info,
                                  &component_value))
    {
        ...
        if (components_module_get_component_status_by_uninstalled_packages_list(
                module, component_parsed_data, uninstalled_packages, current_arch, current_locales,
                locales_len, current_desktop_environments, de_env_len, &status)
            < 0)
        {
            alterator_ctl_module_info_parser_result_tree_free(component_parsed_data);
            ERR_EXIT();
        ...
        toml_value* draft_status =
            !draft ? g_hash_table_lookup(node_data->toml_pairs,
        ...
        toml_value* parent_category_toml_value = g_hash_table_lookup(
            node_data->toml_pairs, COMPONENT_ALTERATOR_ENTRY_COMPONENT_CATEGORY_KEY_NAME);

        toml_value* component_name_toml_value = g_hash_table_lookup(
            node_data->toml_pairs, COMPONENT_ALTERATOR_ENTRY_COMPONENT_NAME_KEY_NAME);
        ...
        gchar* component_path = components_module_path_from_name(
            component_name_toml_value->str_value);

        gchar* display_name = NULL;
        if (!name_only && !path_only && !no_display_name
            && components_module_get_display_name(module, (gchar*) component_path, COMPONENT,
                                                  component_parsed_data, &display_name)
                   < 0)
        {
        ...
        gchar* parent_category = parent_category_toml_value ? parent_category_toml_value->str_value
                                                            : NULL;
        components_module_tree_elem_t* elem = g_malloc0(sizeof(components_module_tree_elem_t));
        components_module_tree_elem_init(elem, COMPONENT, component_name_toml_value->str_value,
                                         display_name, parent_category);
        elem->installed_status = status;

        GNode* component_tree_node = g_node_new(elem);
        g_hash_table_insert(components_nodes_table, g_strdup(component_name_toml_value->str_value),
                            component_tree_node);
    ...
    if (!ignore_sections)
    {
        GHashTable* section_by_name = g_hash_table_new(g_str_hash, g_str_equal);
        gboolean print_other        = FALSE;
        {
            if (chosen_sections)
                for (gsize i = 0; i < g_strv_length(chosen_sections); i++)
                {
                    if (!g_hash_table_contains(all_section_names, chosen_sections[i])
                        && g_strcmp0(chosen_sections[i], COMPONENTS_OTHER_SECTION_NAME) != 0)
                    {
                        g_printerr(_("Section \"%s\" does not exist.\n"), chosen_sections[i]);
                        g_hash_table_unref(section_by_name);
                        ERR_EXIT();
                    }

                    if (g_strcmp0(chosen_sections[i], COMPONENTS_OTHER_SECTION_NAME) != 0)
                        g_hash_table_add(section_by_name, chosen_sections[i]);
                    else
                        print_other = TRUE;
                }
            else
                for (gsize i = 0; i < amount_of_sections; i++)
                    g_hash_table_add(section_by_name,
                                     ((alterator_entry_node*) sections[i]->data)->node_name);

            print_other |= show_other;

            for (gsize i = 0; i < amount_of_sections; i++)
            {
                gchar* section_name = ((alterator_entry_node*) sections[i]->data)->node_name;
                if (g_hash_table_contains(section_by_name, section_name))
                    g_hash_table_insert(section_by_name, section_name, sections[i]);
            }
        }
        GPtrArray* section_names = g_hash_table_get_keys_as_ptr_array(section_by_name);
        g_ptr_array_sort(section_names, components_module_sort_strings);
        for (gsize i = 0; i < section_names->len; i++)
        {
            const gchar* section_name = section_names->pdata[i];
            GNode* section            = g_hash_table_lookup(section_by_name, section_name);
            gboolean is_first_section = i == 0;
            gboolean is_last_section  = i == section_names->len - 1 && !print_other;
            if (print_components_section(module, section, FALSE, components_nodes_table,
                                         categories_nodes_table, is_first_section, is_last_section)
                < 0)
            {
                g_hash_table_unref(section_by_name);
                g_ptr_array_free(section_names, FALSE);
                ERR_EXIT();
            }
        }
        if (print_other
            && print_components_section(module, NULL, TRUE, components_nodes_table,
                                        categories_nodes_table,
                                        g_hash_table_size(section_by_name) == 0, TRUE)
                   < 0)
        {
            g_hash_table_unref(section_by_name);
            if (section_names)
    ...
    {
        g_hash_table_foreach(components_nodes_table, components_module_create_categories_links,
                             categories_nodes_table);
        g_hash_table_foreach(categories_nodes_table, components_module_create_categories_links,
                             categories_nodes_table);
    ...
    if (all_section_names)
        g_hash_table_destroy(all_section_names);
                                             ...
                                             alteratorctl_ctx_t** ctx)
{
    ...
    if (components_module_validate_object_and_iface(module, component_path,
                                                    COMPONENT_INTERFACE_NAME)
        < 0)
        ERR_EXIT();

    if (module->gdbus_source
            ->alterator_gdbus_source_get_text_of_alterator_entry_by_path(module->gdbus_source,
                                                    ...
                                                    alteratorctl_ctx_t** ctx)
{
    ...
    d_ctx = dbus_ctx_init(ALTERATOR_SERVICE_NAME, component_path, COMPONENT_INTERFACE_NAME,
                                               ...
                                               alteratorctl_ctx_t** ctx)
{
    ...
    GHashTable* component_packages_names           = g_hash_table_new_full(g_str_hash, g_str_equal,
    ...
    if (!(component_packages_table = info_parser->alterator_ctl_module_info_parser_get_node_by_name(
              info_parser, component_parse_info,
              COMPONENT_ALTERATOR_ENTRY_COMPONENT_PACKAGES_TABLE_NAME, -1)))
    {
         ...
         component_package        = g_node_next_sibling(component_package))
    {
        ...
        if (components_module_is_ignore_package_by_arch(module, component_package, &ignore_by_arch,
                                                        current_arch)
            < 0)
            ERR_EXIT();

        gboolean ignore_by_lang = FALSE;
        if (components_module_is_ignore_package_by_language(module, component_package,
                                                            &ignore_by_lang, locales, locales_len)
            < 0)
            ERR_EXIT();

        gboolean ignore_by_desktop_env = FALSE;
        if (components_module_is_ignore_package_by_desktop_env(module, component_package,
                                                               &ignore_by_desktop_env,
                                                               desktop_environments, TRUE, env_len)
            < 0)
            ERR_EXIT();
    ...
    if (components_module_get_component_status(module, (gchar*) component_path, &status,
    ...
    if (components_module_get_display_name(module, component_path, COMPONENT, component_parse_info,
                                           &component_display_name)
        < 0)
        ERR_EXIT();

    toml_value*
        category_value = g_hash_table_lookup(((alterator_entry_node*) component_parse_info->data)
                                                 ->toml_pairs,
    ...
    if (components_module_get_display_name(module, category_value->str_value, CATEGORY, NULL,
    ...
    for (gsize i = 0; i < packages->len; i++)
    {
        if (g_hash_table_contains(component_installed_packages_names, packages->pdata[i]))
            g_print("%s%s%s\n",
                    ...
                    !hide_installed_markers ? " " : "", (gchar*) packages->pdata[i]);
        else
            g_print("%s%s%s\n",
                                               ...
                                               alteratorctl_ctx_t** ctx)
{
    ...
    if (!components_paths_table
        || (components_paths_table && !g_hash_table_size(components_paths_table)))
    {
        g_printerr(_("Can't search unspecified component.\n"));
        ERR_EXIT();
    }
    ...
    while (g_hash_table_iter_next(&iter, (gpointer*) &component_path, NULL))
    {
        gchar* current_component = component_str_id[0] != '/'
                                       ? g_utf8_substring(component_path,
                                                          strlen(COMPONENTS_MODULE_PREFIX_PATH), -1)
                                            ...
                                            alteratorctl_ctx_t* ctx)
{
    ...
    if (!module || !ctx)
    {
        g_printerr(_("Internal error in components module when handle results: *module or *context "
                     "is NULL.\n"));
        ERR_EXIT();
    }
                                           ...
                                           char** argv)
{
    ...
    static GOptionEntry components_module_options[]
        = {{"category", 'c', G_OPTION_FLAG_NONE, G_OPTION_ARG_STRING, &printing_category_name,
           ...
           {"ignore-sections", 'I', G_OPTION_FLAG_NONE, G_OPTION_ARG_NONE, &ignore_sections,
                                                    ...
                                                    "LIST"},
           {"show-other", 'o', G_OPTION_FLAG_NONE, G_OPTION_ARG_NONE, &show_other,
    ...
    {
        g_printerr(
            _("It is not possible to use options --installed and --not-installed together.\n"));
        ERR_EXIT();
    }

    if (ignore_sections && chosen_sections)
    {
        g_printerr(_("It is not possible to use option --ignore-sections and --sections arguments "
                     "together.\n"));
        ERR_EXIT();
    }
    ...
    {
        g_printerr(_("It is not possible to use options --preudo-graphic-tree and --simple-tree "
                     "together.\n"));
        ERR_EXIT();
    }
    ...
    {
        g_printerr(
            _("It is not possible to use options --preudo-graphic-tree and --list together.\n"));
        ERR_EXIT();
    }
    ...
    {
        g_printerr(
            _("The --enable-display-name option can only be used with the --list option.\n"));
        ERR_EXIT();
    }
    else if (enable_display_name && print_pseudo_graphic_tree)
    {
    ...
    {
        g_printerr(_("It is not possible to use options --enable-display-name and "
                     "--no-display-name together.\n"));
        ERR_EXIT();
    }
    else if (ignore_sections && show_other)
    {
        g_printerr(
            _("It is not possible to use options --ignore-sections and --show-other together.\n"));
        ERR_EXIT();
    }
...
int components_module_parse_arguments(AlteratorCtlComponentsModule* module, int argc, char** argv,
                                      alteratorctl_ctx_t** ctx)
{
    int ret                            = 0;
    AlteratorCtlModuleInterface* iface = GET_ALTERATOR_CTL_MODULE_INTERFACE((void*) module);
    ...
    if (!iface)
    {
        g_printerr("%s", _("Internal error in components module while parsing arguments: *iface is "
                           "NULL.\n"));
        ERR_EXIT();
    }
...
int components_module_print_help(gpointer self)
{
    g_print(_("Usage:\n"));
    g_print(
        _("  alteratorctl components [COMMAND [arguments]] [OPTIONS] [PARAMETERS <args...>]\n"));
    g_print(
        _("  alteratorctl components     List all components in a preudo-graphic tree view\n\n"));
    g_print(_("Commands:\n"));
    ...
    g_print(_("  -I, --ignore-sections       Print all components regardless of edition\n"
              "                              sections\n"));
    g_print(_("  -o, --show-other            Display components that do not belong to the\n"
              "                              current edition category (cannot be used together\n"
              "                              with the `--ignore-sections` option)\n"));
                                                 ...
                                                 alteratorctl_ctx_t** ctx)
{
    ...
    if (source->info_parser->alterator_ctl_module_info_parser_get_specified_object_data(
            source->info_parser, source, component_path, COMPONENT_INTERFACE_NAME,
            &parsed_component_alterator_entry)
        < 0)
    {
        g_printerr(_("Error in component module: can't get alterator entry data of component "
                     "%s.\n"),
                   component_str_id);
        ERR_EXIT();
    }
                                                        ...
                                                        alteratorctl_ctx_t** ctx)
{
    ...
    {
        g_printerr(_(
            "Can't handling the result od description method: component path or name is empty.\n"));
        ERR_EXIT();
    }
                                                     ...
                                                     gboolean is_last_section)
{
    ...
    if (!categories_names)
        categories_names = g_hash_table_new_full(g_str_hash, g_str_equal, (GDestroyNotify) g_free,
                                                 NULL);
    ...
    {
        if (!(elem = components_module_get_tree_elem_by_name(root, printing_category_name))
            && is_last_section && !g_hash_table_contains(categories_names, printing_category_name))
        {
                 ...
                 && ((components_module_tree_elem_t*) elem->data)->type == COMPONENT)
        {
            g_printerr(_("Category %s not found: %s is a component, not a category.\n"),
                       printing_category_name, printing_category_name);
            ERR_EXIT();
        }
        else if (!elem
    ...
    if (!hide_installed_markers && is_first_section && !ignore_legend)
    {
        ...
        g_string_append_printf(master_buffer, _("  %s Partially installed\n"),
    ...
    if (print_pseudo_graphic_tree
        ...
        ERR_EXIT();
    else if (print_simple_tree
             && components_module_print_tree_to_buffer(module, output, master_buffer) < 0)
        ERR_EXIT();
    else if (print_list
             && components_module_print_list_to_buffer(module, output, master_buffer) < 0)
        ERR_EXIT();
                                                   ...
                                                   gsize* amount_of_sections)
{
    ...
    if (alterator_ctl_get_registered_module(module->alterator_ctl_app,
                                            ALTERATOR_CTL_EDITIONS_MODULE_NAME, &editions_module)
        < 0)
    {
    ...
    gsize array_size;
    gconstpointer gvar_info = g_variant_get_fixed_array(editions_info_info_array, &array_size,
                                                        sizeof(guint8));
    ...
    GNode* sections = info_parser->alterator_ctl_module_info_parser_get_node_by_name(
        info_parser, parsed_edition_info, COMPONENTS_EDITION_SECTION_TABLE_NAME, -1);
    if (!sections)
    {
...
static gchar** components_module_get_locales(AlteratorCtlComponentsModule* module, gsize* len)
{
    int ret                               = 0;
    AlteratorCtlModule* systeminfo_module = NULL;
    alteratorctl_ctx_t* sys_ctx = alteratorctl_ctx_init_systeminfo(SYSTEMINFO_GET_LOCALES, NULL,
                                                                   NULL);
    GVariant* answer            = NULL;
    GVariant* exit_code         = NULL;
    gchar** result              = NULL;
                                                          ...
                                                          gsize* len)
{
    ...
    AlteratorCtlModule* systeminfo_module = NULL;
    alteratorctl_ctx_t*
        sys_ctx = alteratorctl_ctx_init_systeminfo(SYSTEMINFO_GET_DESKTOP_ENVIRONMENT, NULL, NULL);
    GVariant* answer    = NULL;
    GVariant* exit_code = NULL;
    gchar** result      = NULL;
                                                       ...
                                                       gchar* optional_current_arch)
{
    ...
    toml_value* exclude_archs_array = g_hash_table_lookup(
        ((alterator_entry_node*) package_data->data)->toml_pairs,
...
static int components_module_print_pseudo_graphic_subtree_buffered(
    AlteratorCtlComponentsModule* module, GNode* node, gchar* prefix, gboolean is_last,
    gboolean is_first, GString* buffer)
{
    int ret                      = 0;
    ...
    {
        gchar* path      = data->type == COMPONENT ? components_module_path_from_name(data->name)
                                                   : g_strdup(data->name);
    ...
    if (display_name_only || no_name)
        printing_display_name = g_strconcat(!hide_installed_markers ? " " : "", data->display_name,
                                            NULL);
    ...
    g_string_append_printf(buffer, "%s%s%s%s%s%s\n", prefix, connector,
                           COMPONENTS_MODULE_TREE_HLINE,
                           !hide_installed_markers ? installed_marker : "", printing_display_name,
                           printing_elem_id);
    ...
    while (child)
    {
        ...
        gchar* new_prefix = g_strconcat(prefix, tree_line, !hide_installed_markers ? "  " : " ",
                                        NULL);
        components_module_print_pseudo_graphic_subtree_buffered(module, child, new_prefix,
                                                                child->next == NULL, FALSE, buffer);
        g_free(new_prefix);
        child = child->next;
    }
                                                      ...
                                                      GNode* node, GString* master_buffer)
{
    ...
    while (child)
    {
        if (components_module_print_pseudo_graphic_subtree_buffered(module, child, "",
                                                                    child->next == NULL, is_first,
                                                                    master_buffer))
        {
...
static int components_module_print_subtree_buffered(AlteratorCtlComponentsModule* module,
                                                    GNode* node, gchar* prefix, GString* buffer)
{
    int ret                      = 0;
    gchar* printing_elem_id      = NULL;
    gchar* printing_display_name = NULL;
    ...
    g_string_append_printf(buffer, "%s%s%s%s%s\n", prefix,
                           !installed_marker ? installed_marker : "", connector,
                           printing_display_name, printing_elem_id);
                                                    ...
                                                    GNode* node, gchar* prefix, GString* buffer)
{
    ...
    new_prefix = g_strconcat(!hide_installed_markers ? installed_marker : "", prefix, "/",
                             printing_display_name, printing_elem_id, NULL);
...
static int components_module_update_all_trees_elems_is_installed(GNode* root)
{
    ...
    if (!root)
    {
        g_printerr(_("Incorrect data was passed to update the installation status of components "
                     "and categories.\n"));
        ERR_EXIT();
    }

    g_node_traverse(root, G_POST_ORDER, G_TRAVERSE_ALL, -1,
                    components_module_update_tree_elem_is_installed, root->data);
...
static int components_module_unlink_all_trees_uninstalled_elems(GNode* root)
{
    ...
    {
        g_printerr(
            _("Incorrect data was transmitted to filter out components that not installed.\n"));
        ERR_EXIT();
    }

    g_node_traverse(root, G_POST_ORDER, G_TRAVERSE_ALL, -1,
                    components_module_unlink_uninstalled_tree_elem, root->data);
...
static int components_module_unlink_all_trees_installed_elems(GNode* root)
{
    ...
    g_node_traverse(root, G_POST_ORDER, G_TRAVERSE_ALL, -1,
                    components_module_unlink_installed_tree_elem, root->data);
...
static gboolean components_module_update_tree_elem_is_installed(GNode* node, gpointer data)
{
    ...
    components_module_tree_elem_t* parent_elem = (components_module_tree_elem_t*)
                                                     node->parent->data;
...
static GNode* components_module_get_tree_elem_by_name(GNode* root, const gchar* name)
{
    ...
    g_node_traverse(root, G_POST_ORDER, G_TRAVERSE_ALL, -1,
                    components_module_get_tree_elem_by_name_traverse_func, params);
...
{
    gint result;
    components_module_tree_elem_t* first_node_data  = (components_module_tree_elem_t*) ((
        const GNode*) a);
    components_module_tree_elem_t* second_node_data = (components_module_tree_elem_t*) ((
        const GNode*) b);
    const gchar* first_comparable_data              = NULL;
    const gchar* second_comparable_data             = NULL;
    gboolean is_verbose                             = *((gboolean*) user_data);

    if ((display_name_only || no_name || enable_display_name) && !no_display_name && !path_only
        && !name_only)
    {
    ...
    else if ((no_display_name || name_only || print_list) && !path_only && !display_name_only)
    {
        ...
        second_comparable_data = g_strdup((const gchar*) second_node_data->name);
             ...
             && !display_name_only)
    {
        first_comparable_data = components_module_path_from_name(
            (const gchar*) first_node_data->name);
        second_comparable_data = components_module_path_from_name(
            (const gchar*) second_node_data->name);
    }
    else
    {
        // Default
...
static gboolean components_module_sort_childrens_by_name_traverse_func(GNode* node, gpointer data)
{
    node->children = (GNode*) g_list_sort_with_data((GList*) node->children,
                                                    components_module_sort_tree_compare_func, data);
                                                      ...
                                                      GNode* alterator_entry_data)
{
    ...
    if (!source->info_parser->alterator_ctl_module_info_parser_find_value(
            ...
            COMPONENT_ALTERATOR_ENTRY_COMPONENT_NAME_KEY_NAME, NULL))
    {
        g_printerr(_("Can't get alterator entry data for validation in module components: field "
                     "\"%s\" is missing.\n"),
                   COMPONENT_ALTERATOR_ENTRY_COMPONENT_NAME_KEY_NAME);
        ERR_EXIT();
    }

    if (!source->info_parser->alterator_ctl_module_info_parser_find_table(
            source->info_parser, alterator_entry_data, NULL, -1,
            COMPONENT_ALTERATOR_ENTRY_COMPONENT_PACKAGES_TABLE_NAME, NULL))
    {
        g_printerr(_("Can't get alterator entry data for validation in module components: table "
                     "\"%s\" is missing.\n"),
                                                                 ...
                                                                 GNode* alterator_entry_data)
{
    ...
    if (!source->info_parser->alterator_ctl_module_info_parser_find_value(
            source->info_parser, alterator_entry_data, NULL,
            COMPONENT_CATEGORY_ALTERATOR_ENTRY_COMPONENT_NAME_KEY_NAME, NULL))
    {
        g_printerr(_("Can't get alterator entry data for validation component category info: field "
                     "\"%s\" is missing.\n"),
                                              ...
                                              gchar** result)
{
    ...
    if (type == COMPONENT && !elem_data)
    {
        if (info_parser->alterator_ctl_module_info_parser_get_specified_object_data(
                info_parser, module->gdbus_source, elem_str_id, COMPONENT_INTERFACE_NAME,
                &elem_data)
            < 0)
        {
            g_printerr(_("Can't get display name of component %s. Parsing of component data "
                         "failed.\n"),
                       elem_str_id);
            ERR_EXIT();
        }
    ...
    else if (type == CATEGORY && !elem_data)
    {
        ...
        {
            g_printerr(_("Can't get display name of %s category. Getting of category alterator "
                         "entry failed.\n"),
                       elem_str_id);
            g_free(category_info);
            ERR_EXIT();
        ...
        if (info_parser->alterator_ctl_module_info_parser_get_data_from_text(info_parser,
            ...
            < 0)
        {
            g_printerr(_("Can't get display name of %s category. Parsing of category data "
                         "failed.\n"),
                       elem_str_id);
            g_free(category_info);
            ERR_EXIT();
    ...
    if (!info_parser->alterator_ctl_module_info_parser_find_table(
            ...
            COMPONENT_ALTERATOR_ENTRY_COMPONENT_DISPLAY_NAME_TABLE_NAME, NULL))
    {
        g_printerr(_("Can't get display name of component %s. Display name data by key %s is "
                     "empty.\n"),
                   elem_str_id, COMPONENT_ALTERATOR_ENTRY_COMPONENT_DISPLAY_NAME_TABLE_NAME);
        ERR_EXIT();
    }
                                                      ...
                                                      GNode* data, gchar** result)
{
    ...
    if (!(locale = alterator_ctl_get_effective_language()))
        ERR_EXIT();
    toml_value* display_name_locale_value = g_hash_table_lookup(((alterator_entry_node*)
                                                                     display_name_node->data)
                                                                    ->toml_pairs,
                                                                locale);
    if (!display_name_locale_value)
        display_name_locale_value = g_hash_table_lookup(((alterator_entry_node*)
                                                             display_name_node->data)
                                                            ->toml_pairs,
                                                        LANG_FALLBACK);
...
static gchar* components_module_name_from_path(const gchar* path)
{
    ...
    regex_match = g_regex_new("^(\\/org\\/altlinux\\/alterator\\/component_)(.+)", G_REGEX_DOTALL,
                              0, NULL);
    if (!regex_match)
        return NULL;
                                               ...
                                               alteratorctl_ctx_t** ctx)
{
    ...
    if (components_module_get_packages_of_component(module, &component_packages, parameter1, FALSE)
        < 0)
        ERR_EXIT();
                                                 ...
                                                 GHashTable** result)
{
    ...
    d_ctx = dbus_ctx_init(ALTERATOR_SERVICE_NAME, ALTERATOR_GLOBAL_PATH,
                          BATCH_COMPONENTS_INTERFACE_NAME, BATCH_COMPONENTS_INFO_METHOD_NAME,
                          module->alterator_ctl_app->arguments->verbose);
    if (!d_ctx)
    {
    ...
    components_module_item_installed_status* status)
{
    ...
    toml_value* component_name_toml_value =
        g_hash_table_lookup(data->toml_pairs, COMPONENT_ALTERATOR_ENTRY_COMPONENT_NAME_KEY_NAME);

    if (!(packages_node = module->gdbus_source->info_parser
                              ->alterator_ctl_module_info_parser_get_node_by_name(
                                  module->gdbus_source->info_parser, (GNode*) parsed_component,
                                  COMPONENT_ALTERATOR_ENTRY_COMPONENT_PACKAGES_TABLE_NAME, -1)))
    {
         ...
         component_package        = g_node_next_sibling(component_package))
    {
        ...
        if (components_module_get_package_name(module, component_package, &current_package_name)
            < 0)
            ERR_EXIT();
        ...
        gboolean ignore_by_lang = FALSE;
        if (components_module_is_ignore_package_by_language(module, component_package,
                                                            &ignore_by_lang, current_locales,
                                                            locales_len)
            < 0)
        {
            g_free(current_package_name);
        ...
        if (components_module_is_ignore_package_by_desktop_env(module, component_package,
                                                               &ignore_by_desktop_env,
                                                               current_desktop_environments, TRUE,
                                                               env_len)
            < 0)
        {
            g_free(current_package_name);
                                                      ...
                                                      GHashTable** result)
{
    ...
    d_ctx = dbus_ctx_init(ALTERATOR_SERVICE_NAME, ALTERATOR_GLOBAL_PATH,
                          BATCH_COMPONENTS_INTERFACE_NAME, BATCH_COMPONENTS_STATUS_METHOD_NAME,
                          module->alterator_ctl_app->arguments->verbose);
    if (!d_ctx)
    {
        g_printerr(_("Can't allocate dbus_ctx_t in "
                     "components_module_get_components_uninstalled_packages.\n"));
        ERR_EXIT();
    }
                                                    ...
                                                    GHashTable** packages)
{
    ...
    regex = g_regex_new("^(.+)-((?:\\d+(?:\\.\\w+)*|\\w*))-(alt\\d+.*).(x86_64|ppc64le|i586|armh|"
                        "aarch64|noarch)$",
                        0, 0, NULL);
                                                             ...
                                                             GHashTable** lookup_hash_table)
{
    ...
    if (!module)
    {
        g_printerr(_("Internal data error in components module with args: "
                     "AlteratorCtlComponentsModule *module is NULL in "
                     "\"components remove\".\n"));
        ERR_EXIT();
    }
    ...
    do
    {
        gpointer founded = g_hash_table_lookup((*lookup_hash_table),
                                               (gchar*) installed_packages_list->data);
        if (founded)
                                                        ...
                                                        GHashTable* components_packages)
{
    ...
    p_ctx = alteratorctl_ctx_init_packages(PACKAGES_APT, APT_CHECK_APPLY_PRIV, all_packages, NULL,
                                           NULL);

    if (packages_module_info->module_iface->run(packages_module_info->module_instance, p_ctx) < 0)
        ERR_EXIT();

    if (components_module_print_affected_components(module, component_str_id,
                                                    (GVariant*) p_ctx->results, INSTALL, TRUE)
        < 0)
        ERR_EXIT();
    ...
    GVariant* additional_data_childrens[] = {to_install_var, to_remove_var, extra_remove_var,
    ...
    alteratorctl_ctx_free(p_ctx);
    p_ctx = alteratorctl_ctx_init_packages(PACKAGES_APT, APT_APPLY_ASYNC | APT_INSTALL,
                                           all_packages, NULL,
                                                  ...
                                                  GHashTable** installed_packages)
{
    ...
    if (!module)
    {
        g_printerr(_("Internal error in components module - AlteratorCtlComponentsModule *module "
                     "is NULL in \"components "
                     "status\".\n"));
        ERR_EXIT();
    }
    ...
    if (!component_str_id)
    {
        g_printerr(_("Internal error in components module - path to component is NULL in "
                     "\"components status\".\n"));
        ERR_EXIT();
    }
    ...
    {
        g_printerr(
            _("Internal error in components module - status is NULL in \"components status\".\n"));
        ERR_EXIT();
    }
    ...
    d_ctx = dbus_ctx_init(ALTERATOR_SERVICE_NAME, component_str_id, COMPONENT_INTERFACE_NAME,
    ...
    if (!d_ctx->result)
    {
        g_printerr(_("D-Bus error in components module while calling Status(): failed to produce a "
                     "result in "
                     "component: %s.\n"),
                   component_str_id);
        ERR_EXIT();
    ...
    *status = (*status) == NOT_INSTALLED ? PARTIALLY_INSTALLED : INSTALLED;
    ...
    (*installed_packages) = g_hash_table_new_full(g_str_hash, g_str_equal, (GDestroyNotify) g_free,
                                                  NULL);
                                              ...
                                              alteratorctl_ctx_t** ctx)
{
    ...
    if (components_module_get_packages_of_component(module, &component_packages, component_str_id,
                                                    TRUE)
        < 0)
        ERR_EXIT();
    ...
    {
        if (components_module_remove_component_packages(module, (gchar*) component_str_id,
                                                        component_packages)
            < 0)
            ERR_EXIT();
        else
    ...
    for (gsize i = 0; g_hash_table_iter_next(&iter, &package, NULL); i++)
        if (g_hash_table_contains(component_packages, (gchar*) package))
        {
            ...
            base_components_packages = g_strconcat(tmp ? tmp : "", g_strdup((gchar*) package),
                                                   i
                                                           != g_hash_table_size(
                                                                  base_components_packages_table)
                                                                  - 1
                                                       ? " "
                                                       : "",
                                                   NULL);
                                                       ...
                                                       gboolean is_installed_component)
{
    ...
    gchar* component_path                            = NULL;
    GHashTable* component_packages                   = NULL;
    (*components_packages) = g_hash_table_new_full(g_str_hash, g_str_equal, (GDestroyNotify) g_free,
                                                   NULL);
    AlteratorCtlModuleInfoParser* info_parser = (AlteratorCtlModuleInfoParser*)
                                                    module->gdbus_source->info_parser;
    ...
    {
        g_printerr(
            _("Internal error in components getting installed packages: path or name is empty.\n"));
        ERR_EXIT();
    }
         ...
         component_package        = g_node_next_sibling(component_package))
    {
        ...
        gboolean ignore_by_lang = FALSE;
        if (components_module_is_ignore_package_by_language(module, component_package,
                                                            &ignore_by_lang, NULL, 0)
            < 0)
            ERR_EXIT();

        gboolean ignore_by_desktop_env = FALSE;
        if (components_module_is_ignore_package_by_desktop_env(module, component_package,
                                                               &ignore_by_desktop_env, NULL, FALSE,
                                                               0)
            < 0)
            ERR_EXIT();
    ...
    if (!is_installed_component
        && components_module_get_components_uninstalled_packages(
               module, &component_uninstalled_packages_names)
               < 0)
        ERR_EXIT();
    ...
    while (g_hash_table_iter_next(&iter, (gpointer*) &package_name, &value))
        if (is_installed_component
            && g_hash_table_contains(component_installed_packages_names, package_name))
            g_hash_table_add(*components_packages, g_strdup(package_name));
        else if (!is_installed_component
                 && g_hash_table_contains(component_uninstalled_packages_names, package_name))
            g_hash_table_add(*components_packages, g_strdup(package_name));
                                                       ...
                                                       GHashTable* components_packages)
{
    ...
    p_ctx = alteratorctl_ctx_init_packages(PACKAGES_APT, APT_CHECK_APPLY_PRIV, check_apply_str,
                                           NULL, NULL);
    ...
    if (components_module_print_affected_components(module, component_str_id,
                                                    (GVariant*) p_ctx->results, REMOVE, TRUE)
        < 0)
        ERR_EXIT();
    ...
    alteratorctl_ctx_free(p_ctx);
    p_ctx = alteratorctl_ctx_init_packages(PACKAGES_APT, APT_APPLY_ASYNC | APT_REMOVE, all_packages,
                                           NULL, (gpointer) g_variant_ref(additional_data));
    if (to_install_var)
        g_variant_unref(to_install_var);
    if (to_remove_var)
        g_variant_unref(to_remove_var);
...
{
    int ret                                   = 0;
    GHashTable* packages2components_table     = g_hash_table_new_full(g_str_hash, g_str_equal,
                                                                      (GDestroyNotify) g_free,
                                                                      (GDestroyNotify)
    ...
    if (!target_component_str_id || (target_component_str_id && !strlen(target_component_str_id)))
    {
        ...
        {
            g_printerr(_("Failed to calculate affected components for unknown action with "
    ...
    if (action != INSTALL && action != REMOVE)
    {
        g_printerr(_("Failed to calculate affected components for unknown action with component "
                     "%s.\n"),
    ...
    if (!module)
    {
        g_printerr(_("Failed to calculate affected components for %s of component %s.\n"),
                   action == REMOVE ? _("remove") : _("install"), target_component_str_id);
        ERR_EXIT();
    }

    if (!packages || (packages && !g_strv_length(packages)))
    {
        g_printerr(_("Failed to calculate affected components for %s of component %s. Get empty "
                     "packages list of %s "
                     "component.\n"),
                   action == REMOVE ? _("remove") : _("install"), target_component_str_id,
                   target_component_str_id);
    ...
    if (!result)
    {
        g_printerr(_("Failed to calculate affected components for %s of component %s. Result "
                     "variable is NULL.\n"),
                   action == REMOVE ? _("remove") : _("install"), target_component_str_id);
        ERR_EXIT();
    }
    ...
    if (!components_batch_info
        || (components_batch_info && !g_hash_table_size(components_batch_info)))
    {
        g_printerr(_("Failed to calculate affected components for %s of component %s. Components "
                     "alterator entry info "
                     "is empty.\n"),
                   action == REMOVE ? _("remove") : _("install"), target_component_str_id);
        ERR_EXIT();
    }
    ...
    if (!uninstalled_packages)
    {
        g_printerr(_("Failed to calculate affected components for %s of component %s. Can't get "
                     "uninstalled "
                     "packages list.\n"),
                   action == REMOVE ? _("remove") : _("install"), target_component_str_id);
        ERR_EXIT();
    ...
    while (g_hash_table_iter_next(&iter, &info, NULL))
    {
        ...
        toml_value* component_name_toml =
            g_hash_table_lookup(((alterator_entry_node*) component_info->data)->toml_pairs,
                                COMPONENT_ALTERATOR_ENTRY_COMPONENT_NAME_KEY_NAME);
        gchar* component_name = component_name_toml ? component_name_toml->str_value : NULL;

        toml_value*
            is_draft = g_hash_table_lookup(((alterator_entry_node*) component_info->data)
                                               ->toml_pairs,
                                           COMPONENT_ALTERATOR_ENTRY_COMPONENT_DRAFT_KEY_NAME);
        ...
        components_module_item_installed_status status = NONE;
        components_module_get_component_status_by_uninstalled_packages_list(
            module, component_info, uninstalled_packages, current_arch, current_locales,
            locales_len, current_desktop_environments, de_env_len, &status);
        ...
        if (!(packages = info_parser->alterator_ctl_module_info_parser_get_node_by_name(
                  info_parser, component_info,
                  COMPONENT_ALTERATOR_ENTRY_COMPONENT_PACKAGES_TABLE_NAME, -1)))
        {
            g_printerr(_("Failed to calculate affected components for %s of component %s. Can't "
                         "get packages list of "
                         "component %s.\n"),
                       action == REMOVE ? _("remove") : _("install"), target_component_str_id,
                       component_name);
            ERR_EXIT();
        ...
        for (GNode* package = packages->children; package != NULL;
             package        = g_node_next_sibling(package))
        {
            gboolean ignore_by_arch = FALSE;
            if (components_module_is_ignore_package_by_arch(module, package, &ignore_by_arch,
                                                            current_arch)
                < 0)
                ERR_EXIT();

            gboolean ignore_by_lang = FALSE;
            if (components_module_is_ignore_package_by_language(module, package, &ignore_by_lang,
                                                                current_locales, locales_len)
                < 0)
                ERR_EXIT();

            gboolean ignore_by_desktop_env = FALSE;
            if (components_module_is_ignore_package_by_desktop_env(module, package,
                                                                   &ignore_by_desktop_env,
            ...
            GHashTable* components_names = g_hash_table_lookup(packages2components_table,
                                                               package_name);
            if (!components_names)
            {
                components_names = g_hash_table_new_full(g_str_hash, g_str_equal,
                                                         (GDestroyNotify) g_free, NULL);
                g_hash_table_add(components_names, g_strdup(component_name));
                g_hash_table_insert(packages2components_table, g_strdup(package_name),
                                    components_names);
            }
            else
                g_hash_table_add(components_names, g_strdup(component_name));
    ...
    *result = g_hash_table_new_full(g_str_hash, g_str_equal, (GDestroyNotify) g_free, NULL);
    ...
    {
        GHashTable* components_names_table = g_hash_table_lookup(packages2components_table,
                                                                 packages[i]);
        if (!components_names_table)
            continue;

        GList* components_names = g_hash_table_get_keys(components_names_table);
        for (GList* component_name = components_names; component_name != NULL;
             component_name        = component_name->next)
                                                       ...
                                                       gboolean target_print_separately)
{
    ...
    if (!target_component_str_id || (target_component_str_id && !strlen(target_component_str_id)))
    {
        if (action != INSTALL && action != REMOVE)
        {
            g_printerr(_("Failed to print affected components for unknown action with unspecified "
                         "component.\n"));
            ERR_EXIT();
        }
    ...
    {
        g_printerr(_("Failed to print affected components for %s of component %s. Empty list of "
                     "packages to install "
                     "and to remove.\n"),
                   action == REMOVE ? _("remove") : _("install"), target_component_str_id);
        ERR_EXIT();
    ...
    g_variant_get(packages_check_apply_result, "(m^asm^asm^asi)", &pkgs_to_install, &pkgs_to_remove,
                  &pkgs_extra_remove, &ret);

    if (ret)
    {
        g_printerr(_("Failed to print affected components for %s of component %s. Error from "
                     "getting of packages to "
                     "install and to remove. Exit code: %i.\n"),
                   action == REMOVE ? _("remove") : _("install"), target_component_str_id, ret);
        ERR_EXIT();
    }
    ...
    if (pkgs_to_install && g_strv_length(pkgs_to_install)
        && components_module_calculate_affected_components(module, target_component_str_id,
                                                           pkgs_to_install, INSTALL,
        ...
        || (pkgs_extra_remove && g_strv_length(pkgs_extra_remove)))
    {
            ...
            || (pkgs_extra_remove && g_strv_length(pkgs_extra_remove)))
        {
            ...
            if (components_module_calculate_affected_components(module, target_component_str_id,
                                                                to_all_remove_pkgs, REMOVE,
    ...
    if (components_to_install_table
        && !(target_print_separately && g_hash_table_size(components_to_install_table) == 1)
        && g_hash_table_contains(components_to_install_table, target_component_str_id))
    {
        GPtrArray* components_to_install_arr = g_hash_table_get_keys_as_ptr_array(
            components_to_install_table);
        ...
        {
            g_printerr(_("Failed to print affected components for %s of component %s. Failed to "
                         "make pretty output.\n"),
                       action == REMOVE ? _("remove") : _("install"), target_component_str_id);
    ...
    if (components_to_remove_table
        && !(target_print_separately && g_hash_table_size(components_to_remove_table) == 1)
        && g_hash_table_contains(components_to_remove_table, target_component_str_id))
    {
        GPtrArray* components_to_remove_arr = g_hash_table_get_keys_as_ptr_array(
            components_to_remove_table);
                                                       ...
                                                       GHashTable** result)
{
    ...
    {
        g_printerr(_(
            "Internal error in components module - AlteratorCtlComponentsModule *module is NULL in "
    ...
    toml_value* base_components_arr = g_hash_table_lookup(((alterator_entry_node*)
                                                               section_base->data)
                                                              ->toml_pairs,
                                                          "components");
    if (!base_components_arr
        || (base_components_arr && base_components_arr->type != TOML_DATA_ARRAY_OF_STRING)
        || (base_components_arr && !base_components_arr->array_length))
    {
        g_printerr(
            _("Failed to get base components packages. Failed to get base components list.\n"));
        ERR_EXIT();
    }
    ...
    while (g_hash_table_iter_next(&iter, (gpointer*) &component_alterator_entry, NULL))
    {
        GNode* component_info = NULL;
        if (info_parser
                ->alterator_ctl_module_info_parser_get_data_from_text(info_parser,
                                                                      module->gdbus_source,
        ...
        toml_value*
            component_name = g_hash_table_lookup(((alterator_entry_node*) component_info->data)
                                                     ->toml_pairs,
                                                 COMPONENT_ALTERATOR_ENTRY_COMPONENT_NAME_KEY_NAME);
        ...
        {
            g_printerr(
                _("Failed to get base components packages. Failed to get base component name.\n"));
            ERR_EXIT();
        }
    ...
    *result = g_hash_table_new_full(g_str_hash, g_str_equal, (GDestroyNotify) g_free, NULL);
         ...
         component_info        = g_node_next_sibling(component_info))
    {
        ...
        GNode* component_packages_table = NULL;
        if (!(component_packages_table =
                  info_parser->alterator_ctl_module_info_parser_get_node_by_name(
                      info_parser, component_info,
                      COMPONENT_ALTERATOR_ENTRY_COMPONENT_PACKAGES_TABLE_NAME, -1)))
        {
            g_printerr(_("Can't get component %s packages. Getting base components packages list "
                         "failed.\n"),
                       component_name->str_value);
            ERR_EXIT();
        }

        for (GNode* component_package                     = component_packages_table->children;
             component_package != NULL; component_package = g_node_next_sibling(component_package))
        {
            gboolean ignore_package_by_arch = FALSE;
            if (components_module_is_ignore_package_by_arch(module, component_package,
                                                            &ignore_package_by_arch, arch)
                < 0)
                ERR_EXIT();

            gboolean ignore_by_lang = FALSE;
            if (components_module_is_ignore_package_by_language(module, component_package,
                                                                &ignore_by_lang, locales,
                                                                locales_len)
                < 0)
                ERR_EXIT();
            ...
            if (desktop_environments
                && components_module_is_ignore_package_by_desktop_env(module, component_package,
                                                                      &ignore_by_desktop_env,
