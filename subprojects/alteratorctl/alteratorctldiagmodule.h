...
#define IS_ALTERATOR_CTL_DIAG_MODULE(obj) \
    (G_TYPE_CHECK_INSTANCE_TYPE((obj), TYPE_ALTERATOR_CTL_DIAG_MODULE))
...
#define IS_ALTERATOR_CTL_DIAG_MODULE_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_TYPE((klass), TYPE_ALTERATOR_CTL_DIAG_MODULE))
