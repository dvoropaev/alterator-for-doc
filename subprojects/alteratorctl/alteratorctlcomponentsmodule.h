...
#define ALTERATOR_CTL_COMPONENTS_MODULE(obj)                                 \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), TYPE_ALTERATOR_CTL_COMPONENTS_MODULE, \
...
#define ALTERATOR_CTL_COMPONENTS_MODULE_CLASS(klass)                        \
    (G_TYPE_CHECK_CLASS_CAST((klass), TYPE_ALTERATOR_CTL_COMPONENTS_MODULE, \
...
#define ALTERATOR_CTL_COMPONENTS_MODULE_GET_CLASS(obj)                      \
    (G_TYPE_INSTANCE_GET_CLASS((obj), TYPE_ALTERATOR_CTL_COMPONENTS_MODULE, \
                               AlteratorCtlComponentsModuleClass))
