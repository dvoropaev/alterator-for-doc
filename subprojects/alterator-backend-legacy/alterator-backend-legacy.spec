...
%package -n alterator-interface-framework
Summary: Interface for alterator-framework runner objects
Group: System/Configuration/Other
Version: 0.1.0
Release: alt1
...
%package -n alterator-application-framework
Summary: Runner for alterator-framework objects
Group: System/Configuration/Other
Version: 0.1.0
Release: alt1
...
%description -n alterator-interface-framework
Interface for alterator-framework runner objects.

%description -n alterator-application-legacy
Runner for old alterator modules.

%description -n alterator-application-framework
Runner for alterator-framework objects.
...
install -v -p -m 644 -D legacy/legacy_runner.application %buildroot%_alterator_datadir/applications
install -v -b -m 644 -D legacy/legacy_runner.backend %buildroot%_alterator_datadir/backends
install -v -p -m 755 -D framework/alterator-application-framework %buildroot%_libexecdir/alterator-application-framework/alterator-application-framework
install -v -p -m 644 -D framework/framework_runner.application %buildroot%_alterator_datadir/applications
install -v -b -m 644 -D framework/framework_runner.backend %buildroot%_alterator_datadir/backends
...
%_datadir/dbus-1/interfaces/org.altlinux.alterator.framework1.xml
...
%_alterator_datadir/applications/legacy_runner.application
%_alterator_datadir/backends/legacy_runner.backend

%files -n alterator-application-framework
%exclude %_bindir/*
%dir %_alterator_datadir/applications
%dir %_libexecdir/alterator-application-framework
%_libexecdir/alterator-application-framework/*
%_alterator_datadir/applications/framework_runner.application
%_alterator_datadir/backends/framework_runner.backend
...
if [ $1 = 0 ]; then
    ...
    find %_sysconfdir/alterator/backends -name "autogenerated-framework-*.backend" -type f -print0 | xargs -0 rm -f '{}' ||:
    find %_sysconfdir/alterator/objects -name "autogenerated-framework-*.object" -type f -print0 | xargs -0 rm -f '{}' ||:
fi
