...
#define ALTERATOR_CTL_APP(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), TYPE_ALTERATOR_CTL_APP, AlteratorCtlApp))
#define IS_ALTERATOR_CTL_APP(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), TYPE_ALTERATOR_CTL_APP))
#define ALTERATOR_CTL_APP_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), TYPE_ALTERATOR_CTL_APP, AlteratorCtlClass))
#define IS_ALTERATOR_CTL_APP_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), TYPE_ALTERATOR_CTL_APP))
#define ALTERATOR_CTL_APP_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), TYPE_ALTERATOR_CTL_APP, AlteratorCtlClass))
