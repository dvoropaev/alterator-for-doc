...
#define IS_ALTERATOR_CTL_REMOTE_MODULE(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), TYPE_ALTERATOR_CTL_REMOTE_MODULE))
#define ALTERATOR_CTL_REMOTE_MODULE_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_CAST((klass), TYPE_ALTERATOR_CTL_REMOTE_MODULE, AlteratorCtlRemoteModuleClass))
#define IS_ALTERATOR_CTL_REMOTE_MODULE_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), TYPE_ALTERATOR_CTL_REMOTE_MODULE))
#define ALTERATOR_CTL_REMOTE_MODULE_GET_CLASS(obj) \
    (G_TYPE_INSTANCE_GET_CLASS((obj), TYPE_ALTERATOR_CTL_REMOTE_MODULE, AlteratorCtlRemoteModuleClass))
